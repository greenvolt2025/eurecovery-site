        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12">
            ...
            <div className="text-center space-y-6">
              ...
              <div className="space-y-2">
                <p className="text-5xl font-light text-gray-900">
                  100 <span className="text-2xl text-gray-600">€</span>
                </p>
              ...
              <Button
                ...
                className="w-full bg-transparent border-2 border-blue-600 hover:bg-blue-50 text-blue-600 py-6 rounded-xl transition-all duration-300 font-semibold"
              >
          ...
          <Card className="p-8 border-2 border-blue-600 transition-all duration-300 bg-white backdrop-blur-sm relative glow-blue-strong card-hover">
            ...
            <div className="text-center space-y-6">
              ...
              <div className="space-y-2">
                <p className="text-5xl font-light text-gray-900">
                  {t.pricing.fromPrice} 5000 <span className="text-2xl text-gray-600">€</span>
                </p>
