        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <a href="#technology" className="text-sm text-gray-600 hover:text-blue-600 transition-colors">Технології</a>
              ...
              <a href="#resources" className="text-sm text-gray-600 hover:text-blue-600 transition-colors">Ресурси</a>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-4 pb-4 space-y-3 border-t border-gray-200 pt-4">
              ...
              <a href="#technology" onClick={() => setMobileMenuOpen(false)} className="block text-sm text-gray-600 hover:text-blue-600 transition-colors">Технології</a>
              ...
              <a href="#resources" onClick={() => setMobileMenuOpen(false)} className="block text-sm text-gray-600 hover:text-blue-600 transition-colors">Ресурси</a>
