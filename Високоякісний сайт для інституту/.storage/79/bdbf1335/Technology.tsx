  ...
  const technologies = [
    {
      ...
      titleUk: 'Суперпровідні кубіти',
      description: 'Використання суперпровідних схем при наднизьких температурах для створення квантових станів',
      descriptionUk: 'Використання суперпровідних схем при наднизьких температурах для створення квантових станів',
    ...
    {
      title: 'Trapped Ions',
      titleUk: 'Іонні пастки',
      description: 'Використання електромагнітних полів для утримання та маніпуляції іонами як кубітами',
      descriptionUk: 'Використання електромагнітних полів для утримання та маніпуляції іонами як кубітами',
    ...
    },
    {
      ...
      titleUk: 'Фотонні квантові обчислення',
      description: 'Використання фотонів світла для квантових обчислень при кімнатній температурі',
      descriptionUk: 'Використання фотонів світла для квантових обчислень при кімнатній температурі',
    ...
    },
    {
      ...
      titleUk: 'Квантовий відпал',
      description: 'Спеціалізований підхід для розв\'язання оптимізаційних задач через квантові флуктуації',
      descriptionUk: 'Спеціалізований підхід для розв\'язання оптимізаційних задач через квантові флуктуації',
      companies: 'D-Wave',
      visual: (
        <svg className="w-full h-32" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className={`max-w-6xl mx-auto w-full ${isVisible ? 'fade-in' : 'opacity-0'}`}>
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-4xl md:text-5xl font-light tracking-tight text-gray-900">
            Квантові <span className="font-semibold gradient-text">технології</span>
          </h2>
          ...
          <p className="text-lg text-gray-700 font-light max-w-2xl mx-auto mt-6">
            Різні підходи до створення квантових комп'ютерів, кожен з унікальними перевагами
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {technologies.map((tech, index) => (
            ...
            >
              ...
              <h3 className="text-2xl font-semibold mb-3 text-gray-900">{tech.titleUk}</h3>
              <p className="text-gray-600 font-light mb-4 leading-relaxed">
                {tech.descriptionUk}
              </p>
              <div className="pt-3 border-t border-gray-200">
                <p className="text-sm text-gray-500 font-light">
                  <span className="font-semibold text-gray-700">Компанії:</span> {tech.companies}
                </p>
              </div>
            </Card>
          ))}
