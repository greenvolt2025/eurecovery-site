...
export default function Partners() {
  ...
  return (
    <section id="partners" className="min-h-screen flex items-center py-24 px-6 bg-white">
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {partners.map((partner, index) => (
            <Card
              key={index}
              className="p-8 border border-gray-200 hover:border-blue-600 transition-all duration-300 bg-white group cursor-pointer"
            >
