  ...
  const services = [
    {
      ...
      features: [
        t.services.consultationFeature1,
        t.services.consultationFeature2,
        t.services.consultationFeature3,
        t.services.consultationFeature4,
      ],
      visual: (
    ...
    },
    {
      ...
      features: [
        t.services.researchFeature1,
        t.services.researchFeature2,
        t.services.researchFeature3,
        t.services.researchFeature4,
      ],
      visual: (
        <svg className="w-full h-24 mb-4" viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      features: [
        t.services.implementationFeature1,
        t.services.implementationFeature2,
        t.services.implementationFeature3,
        t.services.implementationFeature4,
      ],
      visual: (
        <svg className="w-full h-24 mb-4" viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      features: [
        t.services.supportFeature1,
        t.services.supportFeature2,
        t.services.supportFeature3,
        t.services.supportFeature4,
      ],
      visual: (
        <svg className="w-full h-24 mb-4" viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg">
